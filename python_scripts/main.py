...
if __name__ == '__main__':
    ...
    plt.scatter(S1_locations_final, 0.2*np.ones((len(S1_locations_final),)), color='red', label='S1 locations')
    plt.scatter(S2_locations_final, 0.2*np.ones((len(S2_locations_final),)), color='purple', label='S2 locations')
    plt.legend()
    plt.show()
